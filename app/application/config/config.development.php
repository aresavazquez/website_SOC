...
return array(
	'URL' => $_SERVER['SERVER_PORT'] . $_SERVER['HTTP_HOST'] . str_replace('public', '', dirname($_SERVER['SCRIPT_NAME'])),
	/**
	...
	'EMAIL_PASSWORD_RESET_CONTENT' => 'Anota y guarda tu nueva contraseña: ',
