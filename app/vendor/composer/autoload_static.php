...
class ComposerStaticInitaebafe678e9f2f9baafa152cbeb7d8c3
{
    ...
    public static $fallbackDirsPsr4 = array (
        0 => __DIR__ . '/../..' . '/application/engine',
        1 => __DIR__ . '/../..' . '/application/model',
        2 => __DIR__ . '/../..' . '/application/controller',
    );
    ...
    public static $classMap = array (
        'AdminController' => __DIR__ . '/../..' . '/application/controller/AdminController.php',
        'AltoRouter' => __DIR__ . '/..' . '/altorouter/altorouter/AltoRouter.php',
        'ApiController' => __DIR__ . '/../..' . '/application/controller/ApiController.php',
        'Application' => __DIR__ . '/../..' . '/application/engine/Application.php',
        'Auth' => __DIR__ . '/../..' . '/application/engine/Auth.php',
        'BlogController' => __DIR__ . '/../..' . '/application/controller/BlogController.php',
        'BrokerController' => __DIR__ . '/../..' . '/application/controller/BrokerController.php',
        'Config' => __DIR__ . '/../..' . '/application/engine/Config.php',
        'Controller' => __DIR__ . '/../..' . '/application/engine/Controller.php',
        'Credentials' => __DIR__ . '/../..' . '/application/engine/Credentials.php',
        'Csrf' => __DIR__ . '/../..' . '/application/engine/Csrf.php',
        ...
        'Encryption' => __DIR__ . '/../..' . '/application/engine/Encryption.php',
        'Environment' => __DIR__ . '/../..' . '/application/engine/Environment.php',
        'ErrorController' => __DIR__ . '/../..' . '/application/controller/ErrorController.php',
        'File_Iterator' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Iterator.php',
        'File_Iterator_Facade' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Facade.php',
        'File_Iterator_Factory' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Factory.php',
        'Filter' => __DIR__ . '/../..' . '/application/engine/Filter.php',
        ...
        'IndexController' => __DIR__ . '/../..' . '/application/controller/IndexController.php',
        'Item' => __DIR__ . '/../..' . '/application/model/Item.php',
        'Mail' => __DIR__ . '/../..' . '/application/engine/Mail.php',
        'Mobile_Detect' => __DIR__ . '/../..' . '/application/engine/MobileDetect.php',
        'PDODB' => __DIR__ . '/../..' . '/application/engine/PDODB.php',
        'PDOResult' => __DIR__ . '/../..' . '/application/engine/PDOResult.php',
        ...
        'PasswordsController' => __DIR__ . '/../..' . '/application/controller/PasswordsController.php',
        'Post' => __DIR__ . '/../..' . '/application/model/Post.php',
        ...
        'Redirect' => __DIR__ . '/../..' . '/application/engine/Redirect.php',
        'Request' => __DIR__ . '/../..' . '/application/engine/Request.php',
        'Routes' => __DIR__ . '/../..' . '/application/engine/Routes.php',
        ...
        'Session' => __DIR__ . '/../..' . '/application/engine/Session.php',
        'SimulatorController' => __DIR__ . '/../..' . '/application/controller/SimulatorController.php',
        'Site' => __DIR__ . '/../..' . '/application/model/Site.php',
        'State' => __DIR__ . '/../..' . '/application/model/State.php',
        ...
        'Text' => __DIR__ . '/../..' . '/application/engine/Text.php',
        ...
        'UploadController' => __DIR__ . '/../..' . '/application/controller/UploadController.php',
        'User' => __DIR__ . '/../..' . '/application/model/User.php',
        'Validator' => __DIR__ . '/../..' . '/application/engine/Validator.php',
        'View' => __DIR__ . '/../..' . '/application/engine/View.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitaebafe678e9f2f9baafa152cbeb7d8c3::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitaebafe678e9f2f9baafa152cbeb7d8c3::$prefixDirsPsr4;
            $loader->fallbackDirsPsr4 = ComposerStaticInitaebafe678e9f2f9baafa152cbeb7d8c3::$fallbackDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInitaebafe678e9f2f9baafa152cbeb7d8c3::$prefixesPsr0;
            $loader->classMap = ComposerStaticInitaebafe678e9f2f9baafa152cbeb7d8c3::$classMap;
